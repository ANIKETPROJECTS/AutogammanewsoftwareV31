...
- [WhatsApp Cloud documents](whatsapp-cloud-documents.md) — Meta’s access token does not carry the sender phone number ID; configure that non-secret ID separately before document sends.
